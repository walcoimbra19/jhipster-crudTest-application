...
describe('Cliente e2e test', () => {
  ...
  it('should load Clientes', async () => {
    ...
    expect(await clienteComponentsPage.getTitle()).to.eq('jhipsterCrudTestApplicationApp.cliente.home.title');
  ...
  it('should load create Cliente page', async () => {
    ...
    expect(await clienteUpdatePage.getPageTitle()).to.eq('jhipsterCrudTestApplicationApp.cliente.home.createOrEditLabel');
  ...
  it('should create and save Clientes', async () => {
    ...
    await promise.all([clienteUpdatePage.setRazaoSocialInput('razaoSocial'), clienteUpdatePage.setEmailInput('email')]);

    expect(await clienteUpdatePage.getRazaoSocialInput()).to.eq('razaoSocial', 'Expected RazaoSocial value to be equals to razaoSocial');
  ...
  it('should delete last Cliente', async () => {
    ...
    expect(await clienteDeleteDialog.getDialogTitle()).to.eq('jhipsterCrudTestApplicationApp.cliente.delete.question');
